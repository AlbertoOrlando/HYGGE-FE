            ...
            <div className="payment">
                ...
                <ul>
                    ...
                    <li><a href="#" target="_blank" rel="noreferrer">
                        <img src="../../svg-icons/maestro.svg" alt="" />
                    </a></li>
                    <li><a href="#" target="_blank" rel="noreferrer">
                        <img src="../../svg-icons/apple-pay.svg" alt="" />
                    </a></li>
                    <li><a href="#" target="_blank" rel="noreferrer">
                        <img src="../../svg-icons/mastercard.svg" alt="" />
                    </a></li>
                    <li><a href="#" target="_blank" rel="noreferrer">
                        <img src="../../svg-icons/visa-logo.svg" alt="" />
                    </a></li>
                    <li><a href="#" target="_blank" rel="noreferrer">
                        <img src="../../svg-icons/google-pay.svg" alt="" />
                    </a></li>
                </ul>
            </div>
